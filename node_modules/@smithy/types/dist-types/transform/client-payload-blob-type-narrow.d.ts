...
/// <reference types="node" />
import type { InvokeFunction, InvokeMethod } from "@smithy/types/dist-types/client";
import type { HttpHandlerOptions } from "@smithy/types/dist-types/http";
import type { SdkStream } from "@smithy/types/dist-types/serde";
import type { BrowserRuntimeStreamingBlobPayloadInputTypes, NodeJsRuntimeStreamingBlobPayloadInputTypes, StreamingBlobPayloadInputTypes } from "@smithy/types/dist-types/streaming-payload/streaming-blob-payload-input-types";
import type { NarrowedInvokeFunction, NarrowedInvokeMethod } from "@smithy/types/dist-types/transform/client-method-transforms";
import type { Transform } from "@smithy/types/dist-types/transform/type-transform";
