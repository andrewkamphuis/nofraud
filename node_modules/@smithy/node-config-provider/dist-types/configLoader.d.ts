import { GetterFromEnv } from "@smithy/node-config-provider/dist-types/fromEnv";
import { GetterFromConfig, SharedConfigInit } from "@smithy/node-config-provider/dist-types/fromSharedConfigFiles";
import { FromStaticConfig } from "@smithy/node-config-provider/dist-types/fromStatic";
